...
class TestQuestionAboutImportant:
    questions_and_answers = [("Сколько это стоит? И как оплатить?", "Сутки — 400 рублей. Оплата курьеру — наличными или картой."),
    ...
    def test_questions(self, setup, question, answer):
        ...
        answer_list = main_page.click_answer_and_get_question(question)
